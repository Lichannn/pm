      ...
      child: Column(
        children: [
          Container(
            ...
            child: Image(
              image: AssetImage("asset/images/gambar.jpg"),
            ),
          ),
          Container(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton('Product', Icons.production_quantity_limits_sharp, 0),
                    IconButton('Chat', Icons.chat, 0),
                    IconButton('Sale', Icons.card_travel, 0),
                  ],
                ),
              ],
            ),
          ...
          Positioned.fill(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Isi Produk yang ada di setiap Hari.',
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
